...
XMLDocument::XMLDocument(bool processEntities, Whitespace whitespace)
    : XMLNode(0), _writeBOM(false), _processEntities(processEntities), _errorID(XML_NO_ERROR), _whitespace(whitespace),
      _errorStr1(0), _errorStr2(0), _charBuffer(0), _bufferAlloced(false)
{
...
XMLError XMLDocument::LoadString(const char* str)
{
  Clear();

  _charBuffer    = (char*)str;
  _bufferAlloced = false;
  if(_charBuffer == 0)
  {
    SetError(XML_ERROR_FILE_READ_ERROR, 0, 0);
    return _errorID;
