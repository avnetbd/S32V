#ifndef _ACF_PROCESS_APU_APU_DRAW_SEGMENTS_RGB_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_APU_DRAW_SEGMENTS_RGB_NATIVE_KERNEL_WRAPPER
...
static void APU_DRAW_SEGMENTS_RGB_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
   ...
   APU_DRAW_SEGMENTS_RGB lProcess;
   lProcess.Initialize();
...
#endif //_ACF_PROCESS_APU_APU_DRAW_SEGMENTS_RGB_NATIVE_KERNEL_WRAPPER
