...
* @hideinitializer
*/
#define ETHQ_CFG_USED_RX_QUEUE      2U

/**
* @def      ETHQ_CFG_PRERUN_MAX_CYCLES
* @brief    Limit maximum number of cycles of pre-run code
...
* @hideinitializer
*/
#define ETHQ_CFG_PRERUN_MAX_CYCLES  10U

/**
* @def      ETHQ_CFG_PRERUN_MAX_CYCLES
* @brief    Limit maximum number of application iterations that pre-run code shall wait to receive a frame
* @details  Pre-run code determines which Rx buffer descriptor is active. In order to work, it requires certain rate of
...
* @hideinitializer
*/
#define ETHQ_CFG_PRERUN_WAIT_CYCLES 3U
