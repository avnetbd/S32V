#ifndef _ACF_PROCESS_APU_APU_FACE_DETECTION_LBP_10_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_APU_FACE_DETECTION_LBP_10_NATIVE_KERNEL_WRAPPER
...
where:
   ...
   [7] corresponds to output 'OUTPUT_INTEGRAL_IMAGE'

and 'pArgs = (void*)MYKERNEL_args;'
******************************************************/

static void APU_FACE_DETECTION_LBP_10_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
   ...
   //OUTPUT_INTEGRAL_IMAGE
   ACF_DataDesc OUTPUT_INTEGRAL_IMAGE;
   lpIo = (acf_io_info*)((int32_t)pArgs+7*sizeof(acf_io_info));
   OUTPUT_INTEGRAL_IMAGE.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);

   APU_FACE_DETECTION_LBP_10 lProcess;
   lProcess.Initialize();
   ...
   lProcess.ConnectIO("OUTPUT_INTEGRAL_IMAGE", OUTPUT_INTEGRAL_IMAGE);
   lProcess.Start();
   lProcess.Wait();
}

#endif //_ACF_PROCESS_APU_APU_FACE_DETECTION_LBP_10_NATIVE_KERNEL_WRAPPER
