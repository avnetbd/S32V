#ifndef _ACF_PROCESS_APU_LDWS_REMAP_SOBEL_MEDIAN_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_LDWS_REMAP_SOBEL_MEDIAN_NATIVE_KERNEL_WRAPPER
...
static void LDWS_REMAP_SOBEL_MEDIAN_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
   ...
   LDWS_REMAP_SOBEL_MEDIAN lProcess;
   lProcess.Initialize();
...
#endif //_ACF_PROCESS_APU_LDWS_REMAP_SOBEL_MEDIAN_NATIVE_KERNEL_WRAPPER
