...
C0_LDOPTS += -T $(SDK_ROOT)/build/nbuild/toolchains/aarch64-sa-gnu.lds -lgcc -lc -lm -lrdimon --spec $(SDK_ROOT)/build/nbuild/toolchains/aarch64-sa-gnu-rdimon.specs -Wl,-Map=$@.map
