#ifndef _ACF_PROCESS_APU_RESIZE16_H_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_RESIZE16_H_NATIVE_KERNEL_WRAPPER
...
where:
   ...
   [4] corresponds to output 'DST'

and 'pArgs = (void*)MYKERNEL_args;'
******************************************************/

static void RESIZE16_H_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
...
#endif //_ACF_PROCESS_APU_RESIZE16_H_NATIVE_KERNEL_WRAPPER
