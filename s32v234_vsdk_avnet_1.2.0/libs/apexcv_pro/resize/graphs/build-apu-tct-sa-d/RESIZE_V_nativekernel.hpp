#ifndef _ACF_PROCESS_APU_RESIZE_V_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_RESIZE_V_NATIVE_KERNEL_WRAPPER
...
static void RESIZE_V_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
...
#endif //_ACF_PROCESS_APU_RESIZE_V_NATIVE_KERNEL_WRAPPER
