#ifndef _ACF_PROCESS_APU_CANNY_PROMOTE_EDGES_FULL_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_CANNY_PROMOTE_EDGES_FULL_NATIVE_KERNEL_WRAPPER
...
static void CANNY_PROMOTE_EDGES_FULL_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
   ...
   CANNY_PROMOTE_EDGES_FULL lProcess;
   lProcess.Initialize();
...
#endif //_ACF_PROCESS_APU_CANNY_PROMOTE_EDGES_FULL_NATIVE_KERNEL_WRAPPER
