#ifndef _ACF_PROCESS_APU_RESIZE16_H_V_FLT_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_RESIZE16_H_V_FLT_NATIVE_KERNEL_WRAPPER
...
where:
   ...
   [7] corresponds to output 'DST'

and 'pArgs = (void*)MYKERNEL_args;'
******************************************************/

static void RESIZE16_H_V_FLT_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
   ...
   SRC_WIDTH.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);
   ...
   DST_WIDTH.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);
...
#endif //_ACF_PROCESS_APU_RESIZE16_H_V_FLT_NATIVE_KERNEL_WRAPPER
