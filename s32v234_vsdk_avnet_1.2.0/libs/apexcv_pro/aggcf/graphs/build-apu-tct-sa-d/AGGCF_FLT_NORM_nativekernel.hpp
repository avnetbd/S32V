#ifndef _ACF_PROCESS_APU_AGGCF_FLT_NORM_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_AGGCF_FLT_NORM_NATIVE_KERNEL_WRAPPER
...
where:
   ...
   [2] corresponds to output 'OUTPUT'

and 'pArgs = (void*)MYKERNEL_args;'
******************************************************/

static void AGGCF_FLT_NORM_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
...
#endif //_ACF_PROCESS_APU_AGGCF_FLT_NORM_NATIVE_KERNEL_WRAPPER
