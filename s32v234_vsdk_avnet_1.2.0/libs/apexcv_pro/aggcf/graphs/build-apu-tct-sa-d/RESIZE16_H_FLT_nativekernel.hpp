#ifndef _ACF_PROCESS_APU_RESIZE16_H_FLT_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_RESIZE16_H_FLT_NATIVE_KERNEL_WRAPPER
...
where:
   ...
   [3] corresponds to input 'DST_WIDTH'
...
static void RESIZE16_H_FLT_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
...
#endif //_ACF_PROCESS_APU_RESIZE16_H_FLT_NATIVE_KERNEL_WRAPPER
