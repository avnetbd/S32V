...
static void FIRE8_E1E3S1_nativekernel(void* pArgs)
{
   ...
   FIRE8_E1E3S1_INPUT_IMAGE.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);

   //FIRE8_E1E3S1_INPUT_WEIGHT
   ACF_DataDesc FIRE8_E1E3S1_INPUT_WEIGHT;
   lpIo = (acf_io_info*)((int32_t)pArgs+1*sizeof(acf_io_info));
   FIRE8_E1E3S1_INPUT_WEIGHT.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);

   //FIRE8_E1E3S1_INPUT_PARAMS
   ACF_DataDesc FIRE8_E1E3S1_INPUT_PARAMS;
   lpIo = (acf_io_info*)((int32_t)pArgs+2*sizeof(acf_io_info));
   FIRE8_E1E3S1_INPUT_PARAMS.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);

   //FIRE8_E1E3S1_OUTPUT_S1
   ACF_DataDesc FIRE8_E1E3S1_OUTPUT_S1;
   lpIo = (acf_io_info*)((int32_t)pArgs+3*sizeof(acf_io_info));
   FIRE8_E1E3S1_OUTPUT_S1.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);
