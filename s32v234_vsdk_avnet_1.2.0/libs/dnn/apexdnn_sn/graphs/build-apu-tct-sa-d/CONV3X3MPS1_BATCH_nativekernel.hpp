#ifndef _ACF_PROCESS_APU_CONV3X3MPS1_BATCH_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_CONV3X3MPS1_BATCH_NATIVE_KERNEL_WRAPPER
...
static void CONV3X3MPS1_BATCH_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
   ...
   CONV3X3MPS1_MODULE_INPUT_IMAGE.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);

   //CONV3X3MPS1_MODULE_INPUT_WEIGHT
   ACF_DataDesc CONV3X3MPS1_MODULE_INPUT_WEIGHT;
   lpIo = (acf_io_info*)((int32_t)pArgs+1*sizeof(acf_io_info));
   CONV3X3MPS1_MODULE_INPUT_WEIGHT.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);
   ...
   CONV3X3MPS1_MODULE_INPUT_PARAMS.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);

   //CONV3X3MPS1_MODULE_OUTPUT_S1
   ACF_DataDesc CONV3X3MPS1_MODULE_OUTPUT_S1;
   lpIo = (acf_io_info*)((int32_t)pArgs+3*sizeof(acf_io_info));
   CONV3X3MPS1_MODULE_OUTPUT_S1.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);

   CONV3X3MPS1_BATCH lProcess;
   lProcess.Initialize();
...
#endif //_ACF_PROCESS_APU_CONV3X3MPS1_BATCH_NATIVE_KERNEL_WRAPPER
