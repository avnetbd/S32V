#ifndef _ACF_PROCESS_APU_EXTRACT_CHANNEL_2CH_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_EXTRACT_CHANNEL_2CH_NATIVE_KERNEL_WRAPPER
...
where:
   ...
   [1] corresponds to input 'CH_ID'
   [2] corresponds to output 'OUTPUT_0'

and 'pArgs = (void*)MYKERNEL_args;'
******************************************************/

static void EXTRACT_CHANNEL_2CH_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
...
#endif //_ACF_PROCESS_APU_EXTRACT_CHANNEL_2CH_NATIVE_KERNEL_WRAPPER
