#ifndef _ACF_PROCESS_APU_MERGE_CHANNEL_4CH_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_MERGE_CHANNEL_4CH_NATIVE_KERNEL_WRAPPER
...
static void MERGE_CHANNEL_4CH_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
   ...
   INPUT_1.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);

   //INPUT_2
   ACF_DataDesc INPUT_2;
   lpIo = (acf_io_info*)((int32_t)pArgs+2*sizeof(acf_io_info));
   INPUT_2.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);

   //INPUT_3
   ACF_DataDesc INPUT_3;
   lpIo = (acf_io_info*)((int32_t)pArgs+3*sizeof(acf_io_info));
   INPUT_3.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);
...
#endif //_ACF_PROCESS_APU_MERGE_CHANNEL_4CH_NATIVE_KERNEL_WRAPPER
