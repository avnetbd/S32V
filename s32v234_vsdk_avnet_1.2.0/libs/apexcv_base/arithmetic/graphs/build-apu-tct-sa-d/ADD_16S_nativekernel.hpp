#ifndef _ACF_PROCESS_APU_ADD_16S_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_ADD_16S_NATIVE_KERNEL_WRAPPER
...
static void ADD_16S_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
...
#endif //_ACF_PROCESS_APU_ADD_16S_NATIVE_KERNEL_WRAPPER
