#ifndef _ACF_PROCESS_APU_ACCUMULATE_SQUARED_16S_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_ACCUMULATE_SQUARED_16S_NATIVE_KERNEL_WRAPPER
...
static void ACCUMULATE_SQUARED_16S_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
   ...
   ACCUMULATE_SQUARED_16S lProcess;
   lProcess.Initialize();
...
#endif //_ACF_PROCESS_APU_ACCUMULATE_SQUARED_16S_NATIVE_KERNEL_WRAPPER
