#ifndef _ACF_PROCESS_APU_HT_SEPARABLE_5X5_16S_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_HT_SEPARABLE_5X5_16S_NATIVE_KERNEL_WRAPPER
...
static void HT_SEPARABLE_5X5_16S_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
   ...
   F_ROW.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);

   //F_COL
   ACF_DataDesc F_COL;
   lpIo = (acf_io_info*)((int32_t)pArgs+2*sizeof(acf_io_info));
   F_COL.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);
...
#endif //_ACF_PROCESS_APU_HT_SEPARABLE_5X5_16S_NATIVE_KERNEL_WRAPPER
