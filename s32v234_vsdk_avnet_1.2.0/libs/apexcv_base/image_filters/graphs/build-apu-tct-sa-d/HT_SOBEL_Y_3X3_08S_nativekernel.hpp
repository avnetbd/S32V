#ifndef _ACF_PROCESS_APU_HT_SOBEL_Y_3X3_08S_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_HT_SOBEL_Y_3X3_08S_NATIVE_KERNEL_WRAPPER
...
where:
   ...
   [1] corresponds to output 'BUFFER_0'
   [2] corresponds to output 'OUTPUT_0'

and 'pArgs = (void*)MYKERNEL_args;'
******************************************************/

static void HT_SOBEL_Y_3X3_08S_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
   ...
   //BUFFER_0
   ACF_DataDesc BUFFER_0;
   lpIo = (acf_io_info*)((int32_t)pArgs+1*sizeof(acf_io_info));
   BUFFER_0.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);
   ...
   HT_SOBEL_Y_3X3_08S lProcess;
   lProcess.Initialize();
   lProcess.ConnectIO("INPUT_0", INPUT_0);
   lProcess.ConnectIO("BUFFER_0", BUFFER_0);
   lProcess.ConnectIO("OUTPUT_0", OUTPUT_0);
   lProcess.Start();
   lProcess.Wait();
}

#endif //_ACF_PROCESS_APU_HT_SOBEL_Y_3X3_08S_NATIVE_KERNEL_WRAPPER
