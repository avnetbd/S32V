#ifndef _ACF_PROCESS_APU_INTERP_BILINEAR_GRAYSCALE_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_INTERP_BILINEAR_GRAYSCALE_NATIVE_KERNEL_WRAPPER
...
where:
   ...
   [1] corresponds to input 'DELTA_XY'
   [2] corresponds to output 'OUTPUT_0'

and 'pArgs = (void*)MYKERNEL_args;'
******************************************************/

static void INTERP_BILINEAR_GRAYSCALE_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
   ...
   //DELTA_XY
   ACF_DataDesc DELTA_XY;
   lpIo = (acf_io_info*)((int32_t)pArgs+1*sizeof(acf_io_info));
   DELTA_XY.Init2D(0, (void*)lpIo->pBuf, lpIo->width, lpIo->height, lpIo->span, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);
   ...
   INTERP_BILINEAR_GRAYSCALE lProcess;
   lProcess.Initialize();
   lProcess.ConnectIO("INPUT_0", INPUT_0);
   lProcess.ConnectIO("DELTA_XY", DELTA_XY);
   lProcess.ConnectIO("OUTPUT_0", OUTPUT_0);
   lProcess.Start();
   lProcess.Wait();
}

#endif //_ACF_PROCESS_APU_INTERP_BILINEAR_GRAYSCALE_NATIVE_KERNEL_WRAPPER
